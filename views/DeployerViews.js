...
exports.Deploying = class extends React.Component {
  render() {
    return (
      <div>Creating your stream... please wait.<br/><img style={{marginTop: '5%', color:'black'}} alt="Loader" src={loader}/></div>
  ...
  render() {
    ...
    return (
      <div className='Card'>
        ...
        <h2>Help Page</h2>
        Medical Record is an open alternative that is also censorship-resistant and open to everyone.
        </div>
        <div id='custom-terminology' style={{textAlign:'left', fontSize:'20px', marginTop:'3%', marginBottom:'3%',marginLeft:'1%'}}>
          ...
          <ul>
            <li><strong>Enter your Medical Records:</strong> a Record of utmost 140 characters shared by a user.</li><br/>
            <li><strong>Stream:</strong> a collection of records that a user can post to and other users can subscribe to read records.</li> <br/>
        ...
        <div id='using-the-app' style={{textAlign:'left', fontSize:'20px', marginTop:'3%', marginBottom:'3%',marginLeft:'1%'}}>
          ...
          <ul>
          <li>To create a stream, click on<img className='Icons' alt="Post" src={post} /> Post Record on the top.</li> <br/>
          ...
          <li>Share this info with your medical personnel</li> <br/>
          <li><strong>Note:</strong> Atleast one user must subscribe to your stream before you can start sharing your records.</li> <br/>
          </ul>
          ...
          <ul>
            ...
            <li>You should have received the Contract Info of a stream created by your patient. If not, please ask your patient to share it</li><br/>
            <li>Enter the contract information shared that your patient (the creator of the stream) shared to subscribe.</li> <br/>
          </ul>
          <strong>Read Records:</strong>
          <ul>
            <li>In the <img className='Icons' src={read} alt="Read" /> Read Record section, you can view all the Record from the streams you've subscribed to earlier.</li> <br/>
...
exports.SeePost = class extends React.Component {
  render() {
    ...
    return (
      <div >
        Uploading your Records.... please wait.
        <br/>
        <img src={loader} alt="Loader" style={{marginTop: '5%'}}/>
...
exports.ContinueOrStop = class extends React.Component {
  render() {
    ...
    return (
      <div className='CardDeploy'>
          Do you want to continue or stop posting Records?
          <br/>
         <button
          onClick={() => {
