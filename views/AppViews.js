...
import all_logos from './assets/Reach-algo.png'
        ...
        <header className="App-header" id="root" style={{backgroundColor:'white'}} >
          {home ? null : 
            <div style={{textAlign: 'left'}}>
              <img src={logo} alt="Medical Record" style={{textAlign: 'left',display:'inline',verticalAlign:'top', height:'100px', marginLeft: '10%', width:'225px'}} onClick={() => parent.skipFundAccount()}/>
          ...
          <footer style={{position:'fixed', bottom:'0', width:'100%', backgroundColor:'#28363D'}}>
            ...
            <p style={{fontSize:'20px', color:'white'}}>&#169; Medical Record 2021</p>
  ...
  render() {
    ...
    return (
      <div style={{marginTop: '10%'}}>
        ...
        <div style={card}>
           <img src={logo} alt="" style={{height:'100%', marginLeft: '10%', width:'90%', marginBottom: '2%'}}/>
            <br/>
            <em style={{fontSize:'60%'}}>Censorship-resistant Medical Record application.</em>
            <br />
            <p>
              <button
      ...
      <div >
        ...
        <div style={about_us}>
          ...
          <div style={{fontSize:'20px', textAlign:'center', marginTop: '3%', padding: '10px', marginBottom:'2%'}}>
            <strong>Medical Record</strong> is a Decentralized Application (DApp) developed using <strong><a href="https://reach.sh/">Reach</a></strong> and the <strong><a href="https://www.algorand.com/">Algorand</a></strong> blockchain platform.<br/>
            It was developed as a project during the Algo Jam Hackathon 2022.
            <br/>
          </div>
        </div>
